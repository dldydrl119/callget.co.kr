$(document).ready(function(){
  ...
  $('body').on('click', '#getcall', function() {
    var data = jsonreturn('/syrup/syrup/updateGet/'+$(this).attr('data-idx'));
  ...
  $('body').on('click', '.cate_list, .syrup_cate_list', function() {
    var cate_num = $(this).data('number');
    var content = $(this).attr( 'class' )

    var url = '';
    if (content.indexOf('syrup_cate_list') != -1) {
      url = '/syrup/syrup/getMainListCate/' + cate_num;
    } else {
