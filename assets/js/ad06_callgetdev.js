$(document).ready(function(){
  ...
  $('body').on('click', '#getcall', function() {
    var data = jsonreturn('/ad06/ad06/updateGet/'+$(this).attr('data-idx'));
  ...
  $('body').on('click', '.cate_list, .ad06_cate_list', function() {
    var cate_num = $(this).data('number');
    var content = $(this).attr( 'class' )

    var url = '';
    if (content.indexOf('ad06_cate_list') != -1) {
      url = '/ad06/ad06/getMainListCate/' + cate_num;
    } else {
    ...
    $.ajax(
      ...
      $.each(data.list,function(index, item){
        ...
        html += '<div class="product_area" onclick="location.href=\'/ad06/ad06/get/' + item.product_idx + '\'">';
