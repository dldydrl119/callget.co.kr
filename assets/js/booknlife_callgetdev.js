$(document).ready(function(){
  ...
  $('body').on('click', '#getcall', function() {
    var data = jsonreturn('/booknlife/booknlife/updateGet/'+$(this).attr('data-idx'));
  ...
  $('body').on('click', '.cate_list, .booknlife_cate_list', function() {
    var cate_num = $(this).data('number');
    var content = $(this).attr( 'class' )

    var url = '';
    if (content.indexOf('booknlife_cate_list') != -1) {
      url = '/booknlife/booknlife/getMainListCate/' + cate_num;
    } else {
