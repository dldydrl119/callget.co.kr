$(document).ready(function(){
  ...
  $('body').on('click', '#getcall', function() {
    var data = jsonreturn('/tevent/tevent/updateGet/'+$(this).attr('data-idx'));
  ...
  $('body').on('click', '.cate_list, .tevent_cate_list', function() {
    var cate_num = $(this).data('number');
    var content = $(this).attr( 'class' )

    var url = '';
    if (content.indexOf('tevent_cate_list') != -1) {
      url = '/tevent/tevent/getMainListCate/' + cate_num;
    } else {
