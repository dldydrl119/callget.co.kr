$(document).ready(function(){
  ...
  $('body').on('click', '#getcall', function() {
    var data = jsonreturn('/ad04/ad04/updateGet/'+$(this).attr('data-idx'));
  ...
  $('body').on('click', '.cate_list, .ad04_cate_list', function() {
    var cate_num = $(this).data('number');
    var content = $(this).attr( 'class' )

    var url = '';
    if (content.indexOf('ad04_cate_list') != -1) {
      url = '/ad04/ad04/getMainListCate/' + cate_num;
    } else {
    ...
    var url = '';
    if (content.indexOf('ad04_cate_list') != -1) {
      url = '/ad04/ad04/getMainListCate2/' + cate_num;
    } else {
      url = '/main/getMainListCate2/' + cate_num
    }
    ...
    $.ajax(
      ...
      $.each(data.list,function(index, item){
        ...
        html += '<div class="product_area" onclick="location.href=\'/ad04/ad04/get/' + item.product_idx + '\'">';
