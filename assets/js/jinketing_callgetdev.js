$(document).ready(function(){
  ...
  $('body').on('click', '#getcall', function() {
    var data = jsonreturn('/jinketing/jinketing/updateGet/'+$(this).attr('data-idx'));
  ...
  $('body').on('click', '.cate_list, .jinketing_cate_list', function() {
    var cate_num = $(this).data('number');
    var content = $(this).attr( 'class' )

    var url = '';
    if (content.indexOf('jinketing_cate_list') != -1) {
      url = '/jinketing/jinketing/getMainListCate/' + cate_num;
    } else {
