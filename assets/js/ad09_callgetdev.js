$(document).ready(function(){
  ...
  $('body').on('click', '#getcall', function() {
    var data = jsonreturn('/ad09/ad09/updateGet/'+$(this).attr('data-idx'));
  ...
  $('body').on('click', '.cate_list, .ad09_cate_list', function() {
    var cate_num = $(this).data('number');
    var content = $(this).attr( 'class' )

    var url = '';
    if (content.indexOf('ad09_cate_list') != -1) {
      url = '/ad09/ad09/getMainListCate/' + cate_num;
    } else {
