$(document).ready(function(){
  ...
  $('body').on('click', '#getcall', function() {
    var data = jsonreturn('/ad05/ad05/updateGet/'+$(this).attr('data-idx'));
  ...
  $('body').on('click', '.cate_list, .ad05_cate_list', function() {
    var cate_num = $(this).data('number');
    var content = $(this).attr( 'class' )

    var url = '';
    if (content.indexOf('ad05_cate_list') != -1) {
      url = '/ad05/ad05/getMainListCate/' + cate_num;
    } else {
    ...
    $.ajax(
      ...
      $.each(data.list,function(index, item){
        ...
        html += '<div class="product_area" onclick="location.href=\'/ad05/ad05/get/' + item.product_idx + '\'">';
