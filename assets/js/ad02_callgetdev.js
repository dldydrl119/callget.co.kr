$(document).ready(function(){
  ...
  $('body').on('click', '#getcall', function() {
    var data = jsonreturn('/ad02/ad02/updateGet/'+$(this).attr('data-idx'));
  ...
  $('body').on('click', '.cate_list, .ad02_cate_list', function() {
    var cate_num = $(this).data('number');
    var content = $(this).attr( 'class' )

    var url = '';
    if (content.indexOf('ad02_cate_list') != -1) {
      url = '/ad02/ad02/getMainListCate/' + cate_num;
    } else {
