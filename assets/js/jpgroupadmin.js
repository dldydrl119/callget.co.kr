$(document).ready(function(){
             ...
             $('body').on('click', '#slidego, #slideedit', function() {
                 ...
                 if(check) {
                     ...
                     if($(this).attr('id') == "slidego"){
                         var json = jsonreturn('/jpgroup/admin/slideinsertData',data);
                         if(json.return == true) {
                             alert("등록되었습니다");
                             location.href = "/jpgroup/admin/slideList";
                         }
                     }
                     else {
                         var json = jsonreturn('/jpgroup/admin/slideUpdate',data);
                         if(json.return == true) {
                             alert("수정되었습니다");
                             location.reload();
                         }
             ...
             $('body').on('click', '#yutubego, #yutubeedit', function() {
                 ...
                 if(check) {
                     ...
                     if($(this).attr('id') == "yutubego"){
                         var json = jsonreturn('/jpgroup/admin/yutubeinsertData',data);
                         if(json.return == true) {
                             alert("등록되었습니다");
                             location.href = "/jpgroup/admin/yutubeList";
                         }
                     }
                     else {
                         var json = jsonreturn('/jpgroup/admin/yutubeUpdate',data);
                         if(json.return == true) {
                             alert("수정되었습니다");
                             location.reload();
                         }
             ...
             $('body').on('click', '#categorygo, #categoryedit', function() {
                 ...
                 if(check) {
                     ...
                     if($(this).attr('id') == "categorygo"){
                         var json = jsonreturn('/jpgroup/admin/categoryinsertData',data);
                         if(json.return == true) {
                             alert("등록되었습니다");
                             location.href = "/jpgroup/admin/categoryList";
                         }
                     }
                     else {
                         var json = jsonreturn('/jpgroup/admin/categoryUpdate',data);
                         if(json.return == true) {
                             alert("수정되었습니다");
                             location.reload();
                         }
             ...
             $('body').on('click', '#faqgo, #faqedit', function() {
                 ...
                 if(check) {
                     ...
                     if($(this).attr('id') == "faqgo"){
                         var json = jsonreturn('/jpgroup/admin/faqinsertData',data);
                         if(json.return == true) {
                             alert("등록되었습니다");
                             location.href = "/jpgroup/admin/faqList";
                         }
                     }
                     else {
                         var json = jsonreturn('/jpgroup/admin/faqUpdate',data);
                         if(json.return == true) {
                             alert("수정되었습니다");
                             history.back();
                         }
             ...
             $('body').on('click', '#productgo, #productedit', function() {
                 ...
                 if(check) {
                     ...
                     if($(this).attr('id') == "productgo"){
                         var json = jsonreturn('/jpgroup/admin/productinsertData',data);
                         if(json.return == true) {
                             alert("등록되었습니다");
                             location.href = "/jpgroup/admin/productList";
                         }
                     }
                     else {
                         var json = jsonreturn('/jpgroup/admin/productUpdateData',data);
                         if(json.return == true) {
                             alert("수정되었습니다");
                             location.reload();
                         }
           ...
           $('body').on('click', '#newsgo, #newsedit', function() {
               ...
               if(check) {
                   ...
                   if($(this).attr('id') == "newsgo"){
                       var json = jsonreturn('/jpgroup/admin/newsInsertData',data);
                       if(json.return == true) {
                           alert("등록되었습니다");
                           location.href = "/jpgroup/admin/newsList";
                       }
                   }
                   else {
                       var json = jsonreturn('/jpgroup/admin/newsUpdate',data);
                       if(json.return == true) {
                           alert("수정되었습니다");
                           location.reload();
                       }
         ...
         this.login = function() {
           $('body').on('click', '#ns_logingo', function() {
               ...
               if(req) {
                   var form = $('form')[0];
                   var data = new FormData(form);
                   var json = jsonreturn('/jpgroup/admin/loginData',data);
                   if(json.return == true) {
                       location.href = '/jpgroup/admin/slideList';
                   }
                   else {
    ...
    //
		...
		// });
          ...
          //     location.href = '/jpgroup/admin/estimateView/'+idx;
          // });
