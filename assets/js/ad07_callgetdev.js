$(document).ready(function(){
  ...
  $('body').on('click', '#getcall', function() {
    var data = jsonreturn('/ad07/ad07/updateGet/'+$(this).attr('data-idx'));
  ...
  $('body').on('click', '.cate_list, .ad07_cate_list', function() {
    var cate_num = $(this).data('number');
    var content = $(this).attr( 'class' )

    var url = '';
    if (content.indexOf('ad07_cate_list') != -1) {
      url = '/ad07/ad07/getMainListCate/' + cate_num;
    } else {
