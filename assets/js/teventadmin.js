$(document).ready(function(){
    function admin() {
            ...
            $('body').on('click', '#slidego, #slideedit', function() {
                ...
                if(check) {
                    ...
                    if($(this).attr('id') == "slidego"){
                        var json = jsonreturn('/tevent/admin/slideinsertData',data);
                        if(json.return == true) {
                            alert("등록되었습니다");
                            location.href = "/tevent/admin/slideList";
                        }
                    }
                    else {
                        var json = jsonreturn('/tevent/admin/slideUpdate',data);
                        if(json.return == true) {
                            alert("수정되었습니다");
                            location.reload();
                        }
            ...
            $('body').on('click', '#eventgo, #eventedit', function() {
                ...
                if(check) {
                    ...
                    if($(this).attr('id') == "eventgo"){
                        var json = jsonreturn('/tevent/admin/eventinsertData',data);
                        if(json.return == true) {
                            alert("등록되었습니다");
                            location.href = "/tevent/admin/eventList";
                        }
                    }
                    else {
                        var json = jsonreturn('/tevent/admin/eventUpdate',data);
                        if(json.return == true) {
                            alert("수정되었습니다");
                            location.reload();
                        }
            ...
            $('body').on('click', '#yutubego, #yutubeedit', function() {
                ...
                if(check) {
                    ...
                    if($(this).attr('id') == "yutubego"){
                        var json = jsonreturn('/tevent/admin/yutubeinsertData',data);
                        if(json.return == true) {
                            alert("등록되었습니다");
                            location.href = "/tevent/admin/yutubeList";
                        }
                    }
                    else {
                        var json = jsonreturn('/tevent/admin/yutubeUpdate',data);
                        if(json.return == true) {
                            alert("수정되었습니다");
                            location.reload();
                        }
            ...
            $('body').on('click', '#categorygo, #categoryedit', function() {
                ...
                if(check) {
                    ...
                    if($(this).attr('id') == "categorygo"){
                        var json = jsonreturn('/tevent/admin/categoryinsertData',data);
                        if(json.return == true) {
                            alert("등록되었습니다");
                            location.href = "/tevent/admin/categoryList";
                        }
                    }
                    else {
                        var json = jsonreturn('/tevent/admin/categoryUpdate',data);
                        if(json.return == true) {
                            alert("수정되었습니다");
                            location.reload();
                        }
            ...
            $('body').on('click', '#faqgo, #faqedit', function() {
                ...
                if(check) {
                    ...
                    if($(this).attr('id') == "faqgo"){
                        var json = jsonreturn('/tevent/admin/faqinsertData',data);
                        if(json.return == true) {
                            alert("등록되었습니다");
                            location.href = "/tevent/admin/faqList";
                        }
                    }
                    else {
                        var json = jsonreturn('/tevent/admin/faqUpdate',data);
                        if(json.return == true) {
                            alert("수정되었습니다");
                            history.back();
                        }
            ...
            $('body').on('click', '#productgo, #productedit', function() {
                ...
                if(check) {
                    ...
                    if($(this).attr('id') == "productgo"){
                        var json = jsonreturn('/tevent/admin/productinsertData',data);
                        if(json.return == true) {
                            alert("등록되었습니다");
                            location.href = "/tevent/admin/productList";
                        }
                    }
                    else {
                        var json = jsonreturn('/tevent/admin/productUpdateData',data);
                        if(json.return == true) {
                            alert("수정되었습니다");
                            location.reload();
                        }
            ...
            $('body').on('click', '#newsgo, #newsedit', function() {
                ...
                if(check) {
                    ...
                    if($(this).attr('id') == "newsgo"){
                        var json = jsonreturn('/tevent/admin/newsInsertData',data);
                        if(json.return == true) {
                            alert("등록되었습니다");
                            location.href = "/tevent/admin/newsList";
                        }
                    }
                    else {
                        var json = jsonreturn('/tevent/admin/newsUpdate',data);
                        if(json.return == true) {
                            alert("수정되었습니다");
                            location.reload();
                        }
        ...
        this.login = function() {
            $('body').on('click', '#ns_logingo', function() {
                ...
                if(req) {
                    var form = $('form')[0];
                    var data = new FormData(form);
                    var json = jsonreturn('/tevent/admin/loginData',data);
                    if(json.return == true) {
                        location.href = '/tevent/admin/slideList';
                    }
                    else {
        ...
        //     location.href = '/tevent/admin/estimateView/'+idx;
        // });
