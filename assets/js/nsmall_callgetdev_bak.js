$(document).ready(function(){
  ...
  $('body').on('click', '#getcall', function() {
    var data = jsonreturn('/nsmall/nsmall/updateGet/'+$(this).attr('data-idx'));
