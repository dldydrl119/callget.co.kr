        ...
        <div class="x_panel">
          <div class="x_content">
            ...
            <form class="form-horizontal form-label-left insu">
              ...
              <div class="item form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="slide"> 상품사 영상 or 누끼 이미지 <span class="required">*</span></label>
                <div class="col-md-6 col-sm-6 col-xs-12">
...
<script src="<?= base_url('assets/js/ad09admin.js') ?>?<?= TESTING ?>"></script>