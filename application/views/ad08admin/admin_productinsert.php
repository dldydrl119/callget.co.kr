        ...
        <div class="x_panel">
          <div class="x_content">
            ...
            <form class="form-horizontal form-label-left insu">
              ...
              <div class="item form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="callnames"> 콜페이지문구 <span class="required">*</span></label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" id="callnames2" class="form-control col-md-7 col-xs-12 req product" name="product_callname" value="<?= $data->product_callname ?>" required="required">
                </div>
              </div>
              ...
              <div class="item form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="product_recoment_name1"> 추천 사은품명 <span class="required">*</span></label>
                <div class="col-md-3 col-sm-6 col-xs-6">
                  <input type="text" id="product_recoment_name1" class="form-control col-md-7 col-xs-12 req product" name="product_recoment_name1" value="<?= $data->product_recoment_name1 ?>" required="required">
                </div>
                <label class="control-label col-md-1 col-sm-1 col-xs-6" for="product_recoment_link1"> 링크 <span class="required">*</span></label>
                <div class="col-md-3 col-sm-3 col-xs-6">
                  <input type="text" id="product_recoment_link1" class="form-control col-md-7 col-xs-12 req product" name="product_recoment_link1" value="<?= $data->product_recoment_link1 ?>" required="required">
                </div>
              </div>
              <div class="item form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="product_recoment_img1"> 추천 사은품 썸네일 <span class="required">*</span></label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="file" id="product_recoment_img1" value="<?= $data->product_recoment_img1 ?>">
                  <input type="hidden" name="product_recoment_img1" value="<?= $data->product_recoment_img1 ?>">
                  <img src="<?= SURL ?>/assets/uploads/<?= $data->product_recoment_img1 ?>" <? if ($data->product_recoment_img1 == "") { ?> style="display : none;" <? } ?>>
                </div>
              </div>


              <div class="item form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="product_recoment_name2"> 추천 사은품명 <span class="required">*</span></label>
                <div class="col-md-3 col-sm-6 col-xs-6">
                  <input type="text" id="product_recoment_name2" class="form-control col-md-7 col-xs-12 req product" name="product_recoment_name2" value="<?= $data->product_recoment_name2 ?>" required="required">
                </div>
                <label class="control-label col-md-1 col-sm-1 col-xs-6" for="product_recoment_link2"> 링크 <span class="required">*</span></label>
                <div class="col-md-3 col-sm-3 col-xs-6">
                  <input type="text" id="product_recoment_link2" class="form-control col-md-7 col-xs-12 req product" name="product_recoment_link2" value="<?= $data->product_recoment_link2 ?>" required="required">
                </div>
              </div>
              <div class="item form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="product_recoment_img2"> 추천 사은품 썸네일 <span class="required">*</span></label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="file" id="product_recoment_img2" value="<?= $data->product_recoment_img2 ?>">
                  <input type="hidden" name="product_recoment_img2" value="<?= $data->product_recoment_img2 ?>">
                  <img src="<?= SURL ?>/assets/uploads/<?= $data->product_recoment_img2 ?>" <? if ($data->product_recoment_img2 == "") { ?> style="display : none;" <? } ?>>
                </div>
              </div>


              <div class="item form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="product_recoment_name3"> 추천 사은품명 <span class="required">*</span></label>
                <div class="col-md-3 col-sm-6 col-xs-6">
                  <input type="text" id="product_recoment_name3" class="form-control col-md-7 col-xs-12 req product" name="product_recoment_name3" value="<?= $data->product_recoment_name3 ?>" required="required">
                </div>
                <label class="control-label col-md-1 col-sm-1 col-xs-6" for="product_recoment_link3"> 링크 <span class="required">*</span></label>
                <div class="col-md-3 col-sm-3 col-xs-6">
                  <input type="text" id="product_recoment_link3" class="form-control col-md-7 col-xs-12 req product" name="product_recoment_link3" value="<?= $data->product_recoment_link3 ?>" required="required">
                </div>
              </div>
              <div class="item form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="product_recoment_img3"> 추천 사은품 썸네일 <span class="required">*</span></label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="file" id="product_recoment_img3" value="<?= $data->product_recoment_img3 ?>">
                  <input type="hidden" name="product_recoment_img3" value="<?= $data->product_recoment_img3 ?>">
                  <img src="<?= SURL ?>/assets/uploads/<?= $data->product_recoment_img3 ?>" <? if ($data->product_recoment_img3 == "") { ?> style="display : none;" <? } ?>>
                </div>
              </div>
