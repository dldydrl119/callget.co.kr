...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="custom-collapse">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li>
                            <a href="/ad06/about">콜겟TV란?</a>
                        </li>
                        <li>
                            <a href="/ad06/faq">이용방법</a>
                        </li>
                        <!-- <li>
							<a href="/ad06/news/1">소식</a>
						</li> -->
                        <li>
                            <a href="/ad06/contactus">문의하기</a>
                        </li>
                    </ul>
                </div>
            </div><!-- Container_END -->
    ...
    <section id="get_product2" class="get_product mt60">
        <div class="container">
            <div class="row">
    ...
    <section id="get_main3">
        ...
        <div class="get_area1" id="list">
            <button id="getcall" class="get_btn" data-idx="<?= $data->product_idx ?>">이 사은품 무료로 받기 <p style="font-size:10px; line-height: 0.5em;">(평균소요시간 30초, 24시간)</p></button>
        </div>
        <div class="get_area_m" id="list">
            <button id="getcall" class="get_btn" ">이 사은품 무료로 받기 <p style=" font-size:10px; line-height: 0.5em;">(평균소요시간 30초, 24시간)</p></button>
        </div>
    </section>
    ...
    <div id="pop">
        <article>
            <div class="infoDetail">
                <p class="title">상담완료시<br><strong><?= $data->product_namepop ?></strong><br>무료지급</p>
    ...
    <!-- Get_Product -->
    <section id="get_product2" class="get_product_video mt40">
        <div class="container">
    ...
    <section id="get_product2" class="get_product_notice">
        <div class="container box_padding">
            <div class="row">
    ...
    <script src="/assets/js/ad06_callgetdev.js"></script>
