    ...
    <div id="pop">
        <article>
            <div class="infoDetail_1">
                ...
                <div class="infofoot">
                    <div class="line"></div>
                    <p class="sub_title"><strong>간편하게 전화로 상담 예약하기</strong><br>(평균 통화 시간 <strong>30초</strong>)</p>
                </div>
                <div class="infoimg">
                        ...
                        <div class="cont-area">
                            <div class="brand">
                                ...
                                <a href="<?= $data->product_recoment_link1 ?>">
                                    ...
                                    <div class="item item2"><p><b><?= $data->product_recoment_name1 ?></b></p></div>
                        ...
                        <div class="cont-area">
                            <div class="brand">
                                ...
                                <a href="<?= $data->product_recoment_link2?>">
                                    ...
                                    <div class="item item2"><p><b><?= $data->product_recoment_name2 ?></b></p></div>
                                    <div class="item"><img src="/assets/images/bg/next.png"></div>
                                </a>
                                </div>
                            </div>
                        ...
                        <div class="cont-area">
                            <div class="brand">
                                ...
                                <a href="<?= $data->product_recoment_link3?>">
                                    ...
                                    <div class="item item2"><p><b><?= $data->product_recoment_name3 ?></b></p></div>
                                    <div class="item"><img src="/assets/images/bg/next.png"></div>
                                </a>
                                </div>
                            </div>
