        ...
        <div class="x_panel">
          <div class="x_content">
            ...
            <form class="form-horizontal form-label-left insu">
              ...
              <div class="item form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="text"> 영상 밑 설명입니다 <span class="required">*</span></label>
                <div class="col-md-6 col-sm-6 col-xs-12">
              ...
              <div class="item form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="text"> 광고 심의필 <span class="required">*</span></label>
                <div class="col-md-6 col-sm-6 col-xs-12">
              ...
              <div class="item form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="names"> 상품명2 <span class="required">*</span></label>
                <div class="col-md-6 col-sm-6 col-xs-12">
...
<script src="<?= base_url('assets/js/tmonadmin.js') ?>?<?= TESTING ?>"></script>