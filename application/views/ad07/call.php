...
<head>
    ...
    <!-- <link href="/assets/css/callpop.css" rel="stylesheet" type="text/css">s -->
    <link href="/assets/css/callpoptest.css" rel="stylesheet" type="text/css">
...
<body>
    ...
    <div id="pop">
        <article>
            <div class="infoDetail_1">
                <p class="title"><strong><?= $data->product_titlepop ?> <?= $data->product_subpop ?></strong></p>
                <p class="sub"><?= $data->product_namepop ?></p>
                <!-- <p><strong>[ <?= $data->insure_call ?> ]</strong>으로 지금바로 전화주세요.</p><br> -->
                <div class="infofoot">
                    <div class="line"></div>
                    <p class="sub_title"><strong>간편하게 전화로 상담 예약하기</strong><br>(평균 통화 시간 <strong>30초</strong>)<br><strong class="num">[<?= $data->insure_call ?>] 이 번호로 전화주세요.</strong></p>
                </div>
                <div class="infoimg">
    ...
    <div id="pop2">
        <article>
            <div class="infoDetail_2">
                <div class="bg">
                    <div class="contents">
                        <div class="cont-area">
                            <div class="brand">
                                <div class="title">
                                    <a href="<?= $data->product_recoment_link1 ?>">
                                        <div class="item item1"><img src="/assets/uploads/<?= $data->product_recoment_img1 ?>"></div>
                                        <div class="item item2">
                                            <p><b><?= $data->product_recoment_name1 ?></b></p>
                                        </div>
                                        <div class="item"><img src="/assets/images/bg/next.png"></div>
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div class="cont-area">
                            <div class="brand">
                                <div class="title">
                                    <a href="<?= $data->product_recoment_link2 ?>">
                                        <div class="item item1"><img src="/assets/uploads/<?= $data->product_recoment_img2 ?>"></div>
                                        <div class="item item2">
                                            <p><b><?= $data->product_recoment_name2 ?></b></p>
                                        </div>
                                        <div class="item"><img src="/assets/images/bg/next.png"></div>
                                    </a>
                                </div>
                        ...
                        <div class="cont-area">
                            <div class="brand">
                                <div class="title">
                                    <a href="<?= $data->product_recoment_link3 ?>">
                                        <div class="item item1"><img src="/assets/uploads/<?= $data->product_recoment_img3 ?>"></div>
                                        <div class="item item2">
                                            <p><b><?= $data->product_recoment_name3 ?></b></p>
                                        </div>
                                        <div class="item"><img src="/assets/images/bg/next.png"></div>
                                    </a>
                                </div>
            ...
            <div class="button_zone">
                <button class="infobutton" type="button">취소</button>
                <button id="<?= $data->product_idx ?>" class="infobutton1" onclick="location.href='/ad08'" type="button">더 받으러가기</button>
            </div>
        </article>
    </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            $("#<?= $data->product_idx ?>").click(function() {
                $("#pop2").fadeIn();
                $("#pop2").addClass("black");
            });
            $("#pop2>article").click(function() {
                $(this).parent().fadeOut();
            });
        });
    </script>
