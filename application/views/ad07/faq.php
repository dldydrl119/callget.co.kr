			...
			<div class="row">
				...
				<div class="video-faq">
					<div class="video-container-faq">
						<iframe width="100%" height="100%" src="https://www.youtube.com/embed/vFmTwtTUlfk" frameborder="0" allowfullscreen="true"></iframe>
					</div>
				</div>
				<div class="img-faq">
					<img class="w" src="/assets/images/faq/bottom1.jpg">
					<a href="/main"><img class="w" src="/assets/images/faq/bottom1_button.jpg"></a>
					<img class="w" src="/assets/images/faq/bottom2.jpg">
					<img class="m" src="/assets/images/faq/bottom_m1.jpg">
					<a href="/main"><img class="m" src="/assets/images/faq/bottom_m1_button.jpg"></a>
