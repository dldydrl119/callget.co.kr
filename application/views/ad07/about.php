			...
			<div class="row">
				...
				<div class="video-faq">
					<div class="video-container-faq">
						<iframe width="100%" height="100%" src="https://www.youtube.com/embed/6WS64snAKMk" frameborder="0" allowfullscreen="true"></iframe>
					</div>
				</div>
				<div class="img-faq">
					<img class="w" src="/assets/images/about/bottom1.jpg">
					<a href="/main"><img class="w" src="/assets/images/about/bottom1_button.jpg"></a>
					<img class="w" src="/assets/images/about/bottom2.jpg">
					<a href="/main/faq"><img class="w" src="/assets/images/about/bottom2_button.jpg"></a>
					<img class="w" src="/assets/images/about/bottom3.jpg">
					<a href="/main"><img class="w" src="/assets/images/about/bottom3_button.jpg"></a>
					<img class="w" src="/assets/images/about/bottom4.jpg">
					<a href="/main"><img class="w" src="/assets/images/about/bottom4_button.jpg"></a>
					<img class="w" src="/assets/images/about/bottom5.jpg">
					<img class="m" src="/assets/images/about/bottom_m1.jpg">
					<a href="/main"><img class="m" src="/assets/images/about/bottom_m1_button.jpg"></a>
					<img class="m" src="/assets/images/about/bottom_m2.jpg">
					<a href="/main/faq"><img class="m" src="/assets/images/about/bottom_m2_button.jpg"></a>
					<img class="m" src="/assets/images/about/bottom_m3.jpg">
					<a href="/main"><img class="m" src="/assets/images/about/bottom_m3_button.jpg"></a>
					<img class="m" src="/assets/images/about/bottom_m4.jpg">
					<a href="/main"><img class="m" src="/assets/images/about/bottom_m4_button.jpg"></a>
