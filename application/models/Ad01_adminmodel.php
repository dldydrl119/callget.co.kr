<?php
class ad01_adminmodel extends CI_Model {
    ...
    public function insert_login() {
        ...
        $result = $this->db->insert('ad01_admin', $array);
    ...
    public function loginData() {
        // $_POST['id'] = 'ad01';
        // $_POST['pass'] = 'admin';
        $sql="SELECT admin_idx, admin_id, admin_pass FROM ad01_admin WHERE admin_id = ?";
        $array = array($_POST['id']);
        $data = $this->db->query($sql, $array)->row();

        if (password_verify($_POST['pass'] ,$data->admin_pass) ) {

            setcookie('ad01_id', $_POST['id'], time() + 3600);
            setcookie('ad01_idx', $data->admin_idx, time() + 3600);
...
//slide -----------------------------------------------------------------
    public function slideListData($page = 1) {
        ...
        $sql="SELECT slide_idx, @rownum:=@rownum+1 num, slide_name, slide_image, slide_link, slide_date
                FROM ad01_slide, (SELECT @rownum:=0) TMP
    ...
    public function slideinsertData() {
        ...
        $sql="SELECT slide_idxs FROM ad01_slide order by slide_idxs DESC LIMIT 1";
    ...
    public function slideIdxsUpdate() {
        ...
        for($i=0; $i<count($idxs); $i++) {
            $sql= "UPDATE ad01_slide SET slide_idxs = ? WHERE slide_idx = ?";
    ...
    public function slidedel($idx) {
        $array = array($idx);
        $sql= "DELETE FROM ad01_slide WHERE slide_idx = ?";
        $result = $this->db->query($sql, $array);
        return array('return'=>$result);
    }

    public function slideCount() {
        $sql="SELECT COUNT(*) count  FROM ad01_slide";
    ...
    public function eventListData($page = 1) {
        ...
        $sql="SELECT event_idx, @rownum:=@rownum+1 num, event_name, event_image, event_link, event_date
                FROM ad01_event, (SELECT @rownum:=0) TMP
    ...
    public function eventinsertData() {
        ...
        $sql="SELECT event_idxs FROM ad01_event order by event_idxs DESC LIMIT 1";
    ...
    public function eventData($idx) {
        ...
        $sql="SELECT event_idx, event_name, event_image, event_link
            FROM ad01_event WHERE event_idx = ?";
        return $this->db->query($sql, $array)->row();
    }

    public function eventUpdate() {
        $array = array($_POST['name'], $_POST['image'], $_POST['link'], $_POST['idx']);
        $sql= "UPDATE ad01_event SET event_name = ?, event_image = ?,
    ...
    public function eventIdxsUpdate() {
        ...
        $table = "ad01_event";
        for($i=0; $i<count($idxs); $i++) {
            $sql= "UPDATE ad01_event SET event_idxs = ? WHERE event_idx = ?";
            $array = array($idxs[$i], $idx[$i]);
            $result = $this->db->query($sql, $array);
        }
        return array('return'=>$result);
    ...
    public function eventdel($idx) {
        $array = array($idx);
        $sql= "DELETE FROM ad01_event WHERE event_idx = ?";
        $result = $this->db->query($sql, $array);
        return array('return'=>$result);
    }

    public function eventCount() {
        $sql="SELECT COUNT(*) count  FROM ad01_event";
        return $this->db->query($sql, $array)->row()->count;
    }
...
//-------------------------------------------------------------------------
    ...
    public function categoryListData($page = 1) {
        ...
        $sql="SELECT category_idx, @rownum:=@rownum+1 num, category_name, category_image, category_date
                FROM ad01_category, (SELECT @rownum:=0) TMP
    ...
    public function categoryData($idx) {
        ...
        $sql="SELECT category_idx, category_name, category_image
            FROM ad01_category WHERE category_idx = ?";
        return $this->db->query($sql, $array)->row();
    }

    public function categoryUpdate() {
        $array = array($_POST['name'], $_POST['image'], $_POST['idx']);
        $sql= "UPDATE ad01_category SET category_name = ?, category_image = ?
                WHERE category_idx = ?";
        $result = $this->db->query($sql, $array);
        return array('return'=>$result);
    }
    ...
    public function categorydel($idx) {
        $array = array($idx);
        $sql= "DELETE FROM ad01_category WHERE category_idx = ?";
        $result = $this->db->query($sql, $array);
        return array('return'=>$result);
    }
    ...
    public function faqinsertData() {
        $table = "ad01_faq";
        $sql="SELECT faq_idxs FROM ad01_faq order by faq_idxs DESC LIMIT 1";
    ...
    public function faqListData($page = 1) {
        ...
        $sql="SELECT faq_idx, @rownum:=@rownum+1 num, faq_question, faq_answer
                FROM ad01_faq, (SELECT @rownum:=0) TMP
    ...
    public function faqData($idx) {
        ...
        $sql="SELECT faq_idx, faq_question, faq_answer
            FROM ad01_faq WHERE faq_idx = ?";
        return $this->db->query($sql, $array)->row();
    }

    public function faqUpdate() {
        $array = array($_POST['question'], $_POST['answer'], $_POST['idx']);
        $sql= "UPDATE ad01_faq SET faq_question = ?, faq_answer = ?
                WHERE faq_idx = ?";
        $result = $this->db->query($sql, $array);
        return array('return'=>$result);
    }
    ...
    public function faqIdxsUpdate() {
        ...
        $table = "ad01_faq";
        for($i=0; $i<count($idxs); $i++) {
            $sql= "UPDATE ad01_faq SET faq_idxs = ? WHERE faq_idx = ?";
            $array = array($idxs[$i], $idx[$i]);
            $result = $this->db->query($sql, $array);
        }
        return array('return'=>$result);
    ...
    public function faqdel($idx) {
        $array = array($idx);
        $sql= "DELETE FROM ad01_faq WHERE faq_idx = ?";
        $result = $this->db->query($sql, $array);
        return array('return'=>$result);
    }

    public function faqCount() {
        $sql="SELECT COUNT(*) count  FROM ad01_faq";
        return $this->db->query($sql, $array)->row()->count;
    }

    //상품 관리
    public function productinsertData() {
        $producttable = "ad01_product";
        $insuretable = "ad01_insure";

        $sql="SELECT product_idxs FROM ad01_product order by product_idxs DESC LIMIT 1";
    ...
    public function categorySelectData() {
        $sql="SELECT category_idx, category_name FROM ad01_category";
    ...
    public function productListData($page = 1) {
        ...
        SELECT product_idx
            , category_name, insure_name, insure_call,
                ...
                product_show shows
                 FROM ad01_product
        				JOIN ad01_insure USING(product_idx)
        				LEFT JOIN ad01_category
        				USING(category_idx)  JOIN ( SELECT @rownum := 0) R
          ) A ORDER BY product_idxs DESC
              limit {$limit} offset {$offset}";
        $result = $this->db->query($sql)->result();

        $sql="SELECT COUNT(*) count FROM ad01_product
        JOIN ad01_insure USING(product_idx) JOIN ad01_category
        USING(category_idx)";
        $count = $this->db->query($sql)->row();
    ...
    public function productData($idx) {
        $sql="SELECT product_idx, category_idx, insure_name, insure_call,
              ...
              FROM ad01_product JOIN ad01_insure
    ...
    public function productIdxUpdate() {
        ...
        $table = "ad01_product";
        for($i=0; $i<count($idxs); $i++) {
            $sql= "UPDATE ad01_product SET product_idxs = ? WHERE product_idx = ?";
            $array = array($idxs[$i], $idx[$i]);
            $result = $this->db->query($sql, $array);
        }
        return array('return'=>$result);
    ...
    public function productdel($idx) {
        $array = array($idx);
        $sql= "DELETE FROM ad01_product WHERE product_idx = ?";
        $result = $this->db->query($sql, $array);
        $sql= "DELETE FROM ad01_insure WHERE product_idx = ?";
    ...
    public function productShow() {
        ...
        $sql= "UPDATE ad01_product SET product_show = ?
          WHERE product_idx = ?";
...
//소식---------------------------------------------------------
    public function newsListData($page = 1) {
        ...
        $sql="SELECT news_idx, @rownum:=@rownum+1 num, news_title, news_thumb image,
                ...
                FROM ad01_news, (SELECT @rownum:=0) TMP
                ORDER BY news_idxs DESC
                limit {$limit} offset {$offset}";
        // limit {$limit} offset {$offset}
        $result = $this->db->query($sql)->result();

        $sql="SELECT COUNT(*) count FROM ad01_news";
        $count = $this->db->query($sql)->row();
    ...
    public function newsInsertData() {
        $sql = "INSERT INTO ad01_news (news_title, news_content, news_thumb, news_date) VALUES (?, ?, ?, now())";
        $array = array($_POST['news_title'],$_POST['news_content'],$_POST['news_thumb']);
        $result = $this->db->query($sql,$array);
        $insert_id = $this->db->insert_id();

        $sql="SELECT news_idxs FROM ad01_news order by news_idxs DESC LIMIT 1";
        $news_idxs = $this->db->query($sql)->row()->news_idxs + 1;

        $sql= "UPDATE ad01_news SET news_idxs = ? WHERE news_idx = ?";
    ...
    public function newsShow() {
        ...
        $sql= "UPDATE ad01_news SET news_show = ?
        WHERE news_idx = ?";
        $array = array($show, $_POST['idx']);
        $result = $this->db->query($sql, $array);
        return array('return'=>$result);
    ...
    public function newsUpdate() {
        ...
        $sql= "UPDATE ad01_news SET news_title = ?, news_content = ?, news_thumb = ?
              WHERE news_idx = ?";
        $result = $this->db->query($sql, $array);
        return array('return'=>$result);
    }
    ...
    public function newsDel($idx) {
        $array = array($idx);
        $sql= "DELETE FROM ad01_news WHERE news_idx = ?";
        $result = $this->db->query($sql, $array);
        return array('return'=>$result);
    }
    ...
    public function yutubelistData($page = 1) {
        ...
        $sql="SELECT yutube_idx, @rownum:=@rownum+1 num, yutube_link, yutube_date
                FROM ad01_yutube, (SELECT @rownum:=0) TMP
    ...
    public function yutubeinsertData() {
        ...
        $sql="SELECT yutube_idxs FROM ad01_yutube order by yutube_idxs DESC LIMIT 1";
    ...
    public function yutubeData($idx) {
        ...
        $sql="SELECT yutube_idx, yutube_name, yutube_image, yutube_link
            FROM ad01_yutube WHERE yutube_idx = ?";
        return $this->db->query($sql, $array)->row();
    }

    public function yutubeUpdate() {
        $array = array($_POST['name'], $_POST['image'], $_POST['link'], $_POST['idx']);
        $sql= "UPDATE ad01_yutube SET yutube_name = ?, yutube_image = ?,
    ...
    public function yutubeIdxsUpdate() {
        ...
        $table = "ad01_yutube";
        for($i=0; $i<count($idxs); $i++) {
            $sql= "UPDATE ad01_yutube SET yutube_idxs = ? WHERE yutube_idx = ?";
            $array = array($idxs[$i], $idx[$i]);
            $result = $this->db->query($sql, $array);
        }
        return array('return'=>$result);
    ...
    public function yutubedel($idx) {
        $array = array($idx);
        $sql= "DELETE FROM ad01_yutube WHERE yutube_idx = ?";
        $result = $this->db->query($sql, $array);
        return array('return'=>$result);
    }

    public function yutubeCount() {
        $sql="SELECT COUNT(*) count  FROM ad01_yutube";
        return $this->db->query($sql, $array)->row()->count;
    }
}
