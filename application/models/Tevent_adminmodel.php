<?php
class Tevent_adminmodel extends CI_Model
{
    ...
    public function insert_login()
    {
        ...
        $result = $this->db->insert('tevent_admin', $array);
    ...
    public function loginData()
    {
        // $_POST['id'] = 'tevent';
        // $_POST['pass'] = 'admin';
        $sql = "SELECT admin_idx, admin_id, admin_pass FROM tevent_admin WHERE admin_id = ?";
        $array = array($_POST['id']);
        $data = $this->db->query($sql, $array)->row();

        if (password_verify($_POST['pass'], $data->admin_pass)) {

            setcookie('tevent_id', $_POST['id'], time() + 3600);
            setcookie('tevent_idx', $data->admin_idx, time() + 3600);
    ...
    public function slideListData($page = 1)
    {
        ...
        $sql = "SELECT slide_idx, @rownum:=@rownum+1 num, slide_name, slide_image, slide_link, slide_date
                FROM tevent_slide, (SELECT @rownum:=0) TMP
    ...
    public function slideinsertData()
    {
        ...
        $sql = "SELECT slide_idxs FROM tevent_slide order by slide_idxs DESC LIMIT 1";
    ...
    public function slideData($idx)
    {
        ...
        $sql = "SELECT slide_idx, slide_name, slide_image, slide_link
            FROM tevent_slide WHERE slide_idx = ?";
    ...
    public function slideUpdate()
    {
        ...
        $sql = "UPDATE tevent_slide SET slide_name = ?, slide_image = ?,
    ...
    public function slideIdxsUpdate()
    {
        ...
        for ($i = 0; $i < count($idxs); $i++) {
            $sql = "UPDATE tevent_slide SET slide_idxs = ? WHERE slide_idx = ?";
    ...
    {
        $array = array($idx);
        $sql = "DELETE FROM tevent_slide WHERE slide_idx = ?";
        $result = $this->db->query($sql, $array);
        return array('return' => $result);
    }
    ...
    {
        $sql = "SELECT COUNT(*) count  FROM tevent_slide";
    ...
    public function eventListData($page = 1)
    {
        ...
        $sql = "SELECT event_idx, @rownum:=@rownum+1 num, event_name, event_image, event_link, event_date
                        FROM tevent_event, (SELECT @rownum:=0) TMP
    ...
    public function eventinsertData()
    {
        ...
        $sql = "SELECT event_idxs FROM tevent_event order by event_idxs DESC LIMIT 1";
    ...
    public function eventData($idx)
    {
        ...
        $sql = "SELECT event_idx, event_name, event_image, event_link
                    FROM tevent_event WHERE event_idx = ?";
        return $this->db->query($sql, $array)->row();
    }
    ...
    {
        $array = array($_POST['name'], $_POST['image'], $_POST['link'], $_POST['idx']);
        $sql = "UPDATE tevent_event SET event_name = ?, event_image = ?,
    ...
    public function eventIdxsUpdate()
    {
        ...
        $table = "tevent_event";
        for ($i = 0; $i < count($idxs); $i++) {
            $sql = "UPDATE tevent_event SET event_idxs = ? WHERE event_idx = ?";
            $array = array($idxs[$i], $idx[$i]);
            $result = $this->db->query($sql, $array);
        }
        return array('return' => $result);
    ...
    {
        $array = array($idx);
        $sql = "DELETE FROM tevent_event WHERE event_idx = ?";
        $result = $this->db->query($sql, $array);
        return array('return' => $result);
    }
    ...
    {
        $sql = "SELECT COUNT(*) count  FROM tevent_event";
        return $this->db->query($sql, $array)->row()->count;
    }
    ...
    public function categoryData($idx)
    {
        ...
        $sql = "SELECT category_idx, category_name, category_image
            FROM tevent_category WHERE category_idx = ?";
        return $this->db->query($sql, $array)->row();
    }
    ...
    public function categoryUpdate()
    {
        ...
        $sql = "UPDATE tevent_category SET category_name = ?, category_image = ?
                WHERE category_idx = ?";
        $result = $this->db->query($sql, $array);
        return array('return' => $result);
    }
    ...
    {
        $array = array($idx);
        $sql = "DELETE FROM tevent_category WHERE category_idx = ?";
        $result = $this->db->query($sql, $array);
        return array('return' => $result);
    }
    ...
    {
        $table = "tevent_faq";
        $sql = "SELECT faq_idxs FROM tevent_faq order by faq_idxs DESC LIMIT 1";
    ...
    public function faqListData($page = 1)
    {
        ...
        $sql = "SELECT faq_idx, @rownum:=@rownum+1 num, faq_question, faq_answer
                FROM tevent_faq, (SELECT @rownum:=0) TMP
    ...
    public function faqUpdate()
    {
        ...
        $sql = "UPDATE tevent_faq SET faq_question = ?, faq_answer = ?
                WHERE faq_idx = ?";
        $result = $this->db->query($sql, $array);
        return array('return' => $result);
    }
    ...
    public function faqIdxsUpdate()
    {
        ...
        $table = "tevent_faq";
        for ($i = 0; $i < count($idxs); $i++) {
            $sql = "UPDATE tevent_faq SET faq_idxs = ? WHERE faq_idx = ?";
            $array = array($idxs[$i], $idx[$i]);
            $result = $this->db->query($sql, $array);
        }
        return array('return' => $result);
    ...
    {
        $array = array($idx);
        $sql = "DELETE FROM tevent_faq WHERE faq_idx = ?";
        $result = $this->db->query($sql, $array);
        return array('return' => $result);
    }
    ...
    {
        $sql = "SELECT COUNT(*) count  FROM tevent_faq";
        return $this->db->query($sql, $array)->row()->count;
    }
    ...
    {
        $producttable = "tevent_product";
        $insuretable = "tevent_insure";

        $sql = "SELECT product_idxs FROM tevent_product order by product_idxs DESC LIMIT 1";
    ...
    {
        $sql = "SELECT category_idx, category_name FROM tevent_category";
    ...
    public function productListData($page = 1)
    {
        ...
        SELECT product_idx
            , category_name, insure_name, insure_call,
                ...
                product_show shows
                 FROM tevent_product
        				JOIN tevent_insure USING(product_idx)
        				LEFT JOIN tevent_category
        				USING(category_idx)  JOIN ( SELECT @rownum := 0) R
          ) A ORDER BY product_idxs DESC
              limit {$limit} offset {$offset}";
        $result = $this->db->query($sql)->result();

        $sql = "SELECT COUNT(*) count FROM tevent_product
        JOIN tevent_insure USING(product_idx) JOIN tevent_category
        USING(category_idx)";
        $count = $this->db->query($sql)->row();
    ...
    public function productData($idx)
    {
        $sql = "SELECT product_idx, category_idx, insure_name, insure_call,
              ...
              FROM tevent_product JOIN tevent_insure 
    ...
    public function productIdxUpdate()
    {
        $idxs = $_POST['idxs'];
        $idx = $_POST['idx'];
        $table = "tevent_product";
        for ($i = 0; $i < count($idxs); $i++) {
            $sql = "UPDATE tevent_product SET product_idxs = ? WHERE product_idx = ?";
            $array = array($idxs[$i], $idx[$i]);
            $result = $this->db->query($sql, $array);
        }
        return array('return' => $result);
    ...
    {
        $array = array($idx);
        $sql = "DELETE FROM tevent_product WHERE product_idx = ?";
        $result = $this->db->query($sql, $array);
        $sql = "DELETE FROM tevent_insure WHERE product_idx = ?";
    ...
    public function productShow()
    {
        ...
        $sql = "UPDATE tevent_product SET product_show = ?
          WHERE product_idx = ?";
    ...
    public function newsListData($page = 1)
    {
        ...
        $sql = "SELECT news_idx, @rownum:=@rownum+1 num, news_title, news_thumb image,
                ...
                FROM tevent_news, (SELECT @rownum:=0) TMP
                ORDER BY news_idxs DESC
                limit {$limit} offset {$offset}";
        // limit {$limit} offset {$offset}
        $result = $this->db->query($sql)->result();

        $sql = "SELECT COUNT(*) count FROM tevent_news";
        $count = $this->db->query($sql)->row();
    ...
    {
        $sql = "INSERT INTO tevent_news (news_title, news_content, news_thumb, news_date) VALUES (?, ?, ?, now())";
        $array = array($_POST['news_title'], $_POST['news_content'], $_POST['news_thumb']);
        $result = $this->db->query($sql, $array);
        $insert_id = $this->db->insert_id();

        $sql = "SELECT news_idxs FROM tevent_news order by news_idxs DESC LIMIT 1";
        $news_idxs = $this->db->query($sql)->row()->news_idxs + 1;

        $sql = "UPDATE tevent_news SET news_idxs = ? WHERE news_idx = ?";
    ...
    public function newsShow()
    {
        ...
        $sql = "UPDATE tevent_news SET news_show = ?
        WHERE news_idx = ?";
        $array = array($show, $_POST['idx']);
        $result = $this->db->query($sql, $array);
        return array('return' => $result);
    ...
    public function newsData($idx)
    {
        $sql = "SELECT news_idx, news_title, news_content, news_thumb
            FROM tevent_news WHERE news_idx = ?";
        $array = array($idx);
        return $this->db->query($sql, $array)->row();
    }
    ...
    public function newsUpdate()
    {
        ...
        $sql = "UPDATE tevent_news SET news_title = ?, news_content = ?, news_thumb = ?
              WHERE news_idx = ?";
        $result = $this->db->query($sql, $array);
        return array('return' => $result);
    }
    ...
    {
        $array = array($idx);
        $sql = "DELETE FROM tevent_news WHERE news_idx = ?";
        $result = $this->db->query($sql, $array);
        return array('return' => $result);
    }
    ...
    {
        $sql = "SELECT * FROM tevent_product";
        $result = $this->db->query($sql)->result();;
        return $result;
    }
    ...
    public function yutubelistData($page = 1)
    {
        ...
        $sql = "SELECT yutube_idx, @rownum:=@rownum+1 num, yutube_link, yutube_date
                FROM tevent_yutube, (SELECT @rownum:=0) TMP
    ...
    public function yutubeinsertData()
    {
        ...
        $sql = "SELECT yutube_idxs FROM tevent_yutube order by yutube_idxs DESC LIMIT 1";
    ...
    public function yutubeData($idx)
    {
        ...
        $sql = "SELECT yutube_idx, yutube_name, yutube_image, yutube_link
            FROM tevent_yutube WHERE yutube_idx = ?";
        return $this->db->query($sql, $array)->row();
    }
    ...
    {
        $array = array($_POST['name'], $_POST['image'], $_POST['link'], $_POST['idx']);
        $sql = "UPDATE tevent_yutube SET yutube_name = ?, yutube_image = ?,
    ...
    public function yutubeIdxsUpdate()
    {
        ...
        $table = "tevent_yutube";
        for ($i = 0; $i < count($idxs); $i++) {
            $sql = "UPDATE tevent_yutube SET yutube_idxs = ? WHERE yutube_idx = ?";
            $array = array($idxs[$i], $idx[$i]);
            $result = $this->db->query($sql, $array);
        }
        return array('return' => $result);
    ...
    {
        $array = array($idx);
        $sql = "DELETE FROM tevent_yutube WHERE yutube_idx = ?";
        $result = $this->db->query($sql, $array);
        return array('return' => $result);
    }
    ...
    {
        $sql = "SELECT COUNT(*) count  FROM tevent_yutube";
        return $this->db->query($sql, $array)->row()->count;
    }
}
