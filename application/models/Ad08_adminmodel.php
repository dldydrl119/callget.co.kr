...
//-------------------------------------------------------------------------
    ...
    public function productListData($page = 1)
    {
        ...
        SELECT product_idx
            , category_name, insure_name, insure_call,
        				...
        				product_logo, product_slide, product_name, product_hashtag,product_callname,
    ...
    public function productData($idx)
    {
        $sql = "SELECT product_idx, category_idx, insure_name, insure_call,
              insure_company, insure_logo, insure_video, product_company,
              product_logo, product_slide, product_name, product_hashtag, product_callname, product_namepop, product_titlepop,product_subpop,
              product_time, product_slidevideo, insure_text,insure_text2,
              product_gettext, product_thumb,product_numget,
              product_recoment_img1,product_recoment_img2,product_recoment_img3,
