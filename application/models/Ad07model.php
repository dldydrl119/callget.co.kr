...
class ad07model extends CI_Model
{
    ...
    {  //메인 리스트
        ...
        $sql = "SELECT product_idx, TO_DAYS(CAST(product_time AS DATE)) -
                TO_DAYS(CAST(now() AS DATE)) AS dates,
                product_get, product_logo, insure_logo, product_thumb,
                product_company, insure_company, insure_name, product_name,product_callname,
    ...
    {   //겟 데이터
        $sql = "SELECT product_idx, CONCAT_WS(',',IF(product_slidevideo='',null,product_slidevideo),product_slide) product_slide,
                product_company, insure_company,product_callname, product_logo, insure_logo, product_name,product_namepop, product_titlepop,product_subpop,
    ...
    public function  callData($idx)
    {
        $sql = "SELECT product_idx, product_slide, product_name, insure_call,
                insure_logo, insure_company, insure_name, insure_video,product_namepop, product_titlepop,product_subpop,product_callname,
                TO_DAYS(CAST(product_time AS DATE)) -
                TO_DAYS(CAST(now() AS DATE)) AS dates, insure_text,insure_text2,
                product_thumb,product_recoment_img1,product_recoment_img2,product_recoment_img3,
                product_recoment_link1,product_recoment_link2,product_recoment_link3,
                product_recoment_name1,product_recoment_name2,product_recoment_name3,
