<?php
class Jinketing_adminmodel extends CI_Model
{
    ...
    public function insert_login()
    {
        ...
        $result = $this->db->insert('jinketing_admin', $array);
    ...
    public function loginData()
    {
        // $_POST['id'] = 'jinketing';
        // $_POST['pass'] = 'admin';
        $sql = "SELECT admin_idx, admin_id, admin_pass FROM jinketing_admin WHERE admin_id = ?";
        $array = array($_POST['id']);
        $data = $this->db->query($sql, $array)->row();

        if (password_verify($_POST['pass'], $data->admin_pass)) {

            setcookie('jinketing_id', $_POST['id'], time() + 3600);
            setcookie('jinketing_idx', $data->admin_idx, time() + 3600);
    ...
    public function slideinsertData()
    {
        ...
        $sql = "SELECT slide_idxs FROM jinketing_slide order by slide_idxs DESC LIMIT 1";
    ...
    public function slideData($idx)
    {
        ...
        $sql = "SELECT slide_idx, slide_name, slide_image, slide_link
            FROM jinketing_slide WHERE slide_idx = ?";
    ...
    public function slideUpdate()
    {
        ...
        $sql = "UPDATE jinketing_slide SET slide_name = ?, slide_image = ?,
    ...
    public function slideIdxsUpdate()
    {
        ...
        for ($i = 0; $i < count($idxs); $i++) {
            $sql = "UPDATE jinketing_slide SET slide_idxs = ? WHERE slide_idx = ?";
    ...
    {
        $array = array($idx);
        $sql = "DELETE FROM jinketing_slide WHERE slide_idx = ?";
        $result = $this->db->query($sql, $array);
        return array('return' => $result);
    }
    ...
    {
        $sql = "SELECT COUNT(*) count  FROM jinketing_slide";
    ...
    public function eventinsertData()
    {
        ...
        $sql = "SELECT event_idxs FROM jinketing_event order by event_idxs DESC LIMIT 1";
    ...
    public function eventData($idx)
    {
        ...
        $sql = "SELECT event_idx, event_name, event_image, event_link
                    FROM jinketing_event WHERE event_idx = ?";
        return $this->db->query($sql, $array)->row();
    }
    ...
    {
        $array = array($_POST['name'], $_POST['image'], $_POST['link'], $_POST['idx']);
        $sql = "UPDATE jinketing_event SET event_name = ?, event_image = ?,
    ...
    public function eventIdxsUpdate()
    {
        ...
        $table = "jinketing_event";
        for ($i = 0; $i < count($idxs); $i++) {
            $sql = "UPDATE jinketing_event SET event_idxs = ? WHERE event_idx = ?";
            $array = array($idxs[$i], $idx[$i]);
            $result = $this->db->query($sql, $array);
        }
        return array('return' => $result);
    ...
    {
        $array = array($idx);
        $sql = "DELETE FROM jinketing_event WHERE event_idx = ?";
        $result = $this->db->query($sql, $array);
        return array('return' => $result);
    }
    ...
    {
        $sql = "SELECT COUNT(*) count  FROM jinketing_event";
        return $this->db->query($sql, $array)->row()->count;
    }
    ...
    public function categoryData($idx)
    {
        ...
        $sql = "SELECT category_idx, category_name, category_image
            FROM jinketing_category WHERE category_idx = ?";
        return $this->db->query($sql, $array)->row();
    }
    ...
    public function categoryUpdate()
    {
        ...
        $sql = "UPDATE jinketing_category SET category_name = ?, category_image = ?
                WHERE category_idx = ?";
        $result = $this->db->query($sql, $array);
        return array('return' => $result);
    }
    ...
    {
        $array = array($idx);
        $sql = "DELETE FROM jinketing_category WHERE category_idx = ?";
        $result = $this->db->query($sql, $array);
        return array('return' => $result);
    }
    ...
    {
        $table = "jinketing_faq";
        $sql = "SELECT faq_idxs FROM jinketing_faq order by faq_idxs DESC LIMIT 1";
    ...
    public function faqListData($page = 1)
    {
        ...
        $sql = "SELECT faq_idx, @rownum:=@rownum+1 num, faq_question, faq_answer
                FROM jinketing_faq, (SELECT @rownum:=0) TMP
    ...
    public function faqData($idx)
    {
        ...
        $sql = "SELECT faq_idx, faq_question, faq_answer
            FROM jinketing_faq WHERE faq_idx = ?";
        return $this->db->query($sql, $array)->row();
    }
    ...
    public function faqUpdate()
    {
        ...
        $sql = "UPDATE jinketing_faq SET faq_question = ?, faq_answer = ?
                WHERE faq_idx = ?";
        $result = $this->db->query($sql, $array);
        return array('return' => $result);
    }
    ...
    public function faqIdxsUpdate()
    {
        ...
        $table = "jinketing_faq";
        for ($i = 0; $i < count($idxs); $i++) {
            $sql = "UPDATE jinketing_faq SET faq_idxs = ? WHERE faq_idx = ?";
            $array = array($idxs[$i], $idx[$i]);
            $result = $this->db->query($sql, $array);
        }
        return array('return' => $result);
    ...
    {
        $array = array($idx);
        $sql = "DELETE FROM jinketing_faq WHERE faq_idx = ?";
        $result = $this->db->query($sql, $array);
        return array('return' => $result);
    }
    ...
    {
        $sql = "SELECT COUNT(*) count  FROM jinketing_faq";
        return $this->db->query($sql, $array)->row()->count;
    }
    ...
    {
        $producttable = "jinketing_product";
        $insuretable = "jinketing_insure";

        $sql = "SELECT product_idxs FROM jinketing_product order by product_idxs DESC LIMIT 1";
    ...
    {
        $sql = "SELECT category_idx, category_name FROM jinketing_category";
    ...
    public function productListData($page = 1)
    {
        ...
        SELECT product_idx
            , category_name, insure_name, insure_call,
        				...
        				product_logo, product_slide, product_name,product_namepop, product_hashtag,
        				CONCAT(TO_DAYS(CAST(product_time AS DATE)) -
        						TO_DAYS(CAST(now() AS DATE)),'일') AS dates
        				,CONCAT(product_get,'개') product_get, product_idxs,
                product_show shows
                 FROM jinketing_product
        				JOIN jinketing_insure USING(product_idx)
        				LEFT JOIN jinketing_category
        				USING(category_idx)  JOIN ( SELECT @rownum := 0) R
          ) A ORDER BY product_idxs DESC
              limit {$limit} offset {$offset}";
        $result = $this->db->query($sql)->result();

        $sql = "SELECT COUNT(*) count FROM jinketing_product
        JOIN jinketing_insure USING(product_idx) JOIN jinketing_category
        USING(category_idx)";
        $count = $this->db->query($sql)->row();
    ...
    public function productData($idx)
    {
        $sql = "SELECT product_idx, category_idx, insure_name, insure_call,
              ...
              product_gettext, product_thumb,product_titlepop,
              product_numget,product_subpop
              FROM jinketing_product JOIN jinketing_insure
    ...
    public function productIdxUpdate()
    {
        $idxs = $_POST['idxs'];
        $idx = $_POST['idx'];
        $table = "jinketing_product";
        for ($i = 0; $i < count($idxs); $i++) {
            $sql = "UPDATE jinketing_product SET product_idxs = ? WHERE product_idx = ?";
            $array = array($idxs[$i], $idx[$i]);
            $result = $this->db->query($sql, $array);
        }
        return array('return' => $result);
    ...
    {
        $array = array($idx);
        $sql = "DELETE FROM jinketing_product WHERE product_idx = ?";
        $result = $this->db->query($sql, $array);
        $sql = "DELETE FROM jinketing_insure WHERE product_idx = ?";
    ...
    public function productShow()
    {
        ...
        $sql = "UPDATE jinketing_product SET product_show = ?
          WHERE product_idx = ?";
    ...
    public function newsListData($page = 1)
    {
        ...
        $sql = "SELECT news_idx, @rownum:=@rownum+1 num, news_title, news_thumb image,
                ...
                FROM jinketing_news, (SELECT @rownum:=0) TMP
                ORDER BY news_idxs DESC
                limit {$limit} offset {$offset}";
        // limit {$limit} offset {$offset}
        $result = $this->db->query($sql)->result();

        $sql = "SELECT COUNT(*) count FROM jinketing_news";
        $count = $this->db->query($sql)->row();
    ...
    {
        $sql = "INSERT INTO jinketing_news (news_title, news_content, news_thumb, news_date) VALUES (?, ?, ?, now())";
        $array = array($_POST['news_title'], $_POST['news_content'], $_POST['news_thumb']);
        $result = $this->db->query($sql, $array);
        $insert_id = $this->db->insert_id();

        $sql = "SELECT news_idxs FROM jinketing_news order by news_idxs DESC LIMIT 1";
        $news_idxs = $this->db->query($sql)->row()->news_idxs + 1;

        $sql = "UPDATE jinketing_news SET news_idxs = ? WHERE news_idx = ?";
    ...
    public function newsShow()
    {
        ...
        $sql = "UPDATE jinketing_news SET news_show = ?
        WHERE news_idx = ?";
        $array = array($show, $_POST['idx']);
        $result = $this->db->query($sql, $array);
        return array('return' => $result);
    ...
    public function newsData($idx)
    {
        $sql = "SELECT news_idx, news_title, news_content, news_thumb
            FROM jinketing_news WHERE news_idx = ?";
        $array = array($idx);
        return $this->db->query($sql, $array)->row();
    }
    ...
    public function newsUpdate()
    {
        ...
        $sql = "UPDATE jinketing_news SET news_title = ?, news_content = ?, news_thumb = ?
              WHERE news_idx = ?";
        $result = $this->db->query($sql, $array);
        return array('return' => $result);
    }
    ...
    {
        $array = array($idx);
        $sql = "DELETE FROM jinketing_news WHERE news_idx = ?";
        $result = $this->db->query($sql, $array);
        return array('return' => $result);
    }
    ...
    {
        $sql = "SELECT * FROM jinketing_product";
        $result = $this->db->query($sql)->result();;
        return $result;
    }
    ...
    public function yutubeinsertData()
    {
        ...
        $sql = "SELECT yutube_idxs FROM jinketing_yutube order by yutube_idxs DESC LIMIT 1";
    ...
    public function yutubeData($idx)
    {
        ...
        $sql = "SELECT yutube_idx, yutube_name, yutube_image, yutube_link
            FROM jinketing_yutube WHERE yutube_idx = ?";
        return $this->db->query($sql, $array)->row();
    }
    ...
    {
        $array = array($_POST['name'], $_POST['image'], $_POST['link'], $_POST['idx']);
        $sql = "UPDATE jinketing_yutube SET yutube_name = ?, yutube_image = ?,
    ...
    public function yutubeIdxsUpdate()
    {
        ...
        $table = "jinketing_yutube";
        for ($i = 0; $i < count($idxs); $i++) {
            $sql = "UPDATE jinketing_yutube SET yutube_idxs = ? WHERE yutube_idx = ?";
            $array = array($idxs[$i], $idx[$i]);
            $result = $this->db->query($sql, $array);
        }
        return array('return' => $result);
    ...
    {
        $array = array($idx);
        $sql = "DELETE FROM jinketing_yutube WHERE yutube_idx = ?";
        $result = $this->db->query($sql, $array);
        return array('return' => $result);
    }
    ...
    {
        $sql = "SELECT COUNT(*) count  FROM jinketing_yutube";
        return $this->db->query($sql, $array)->row()->count;
    }
}
