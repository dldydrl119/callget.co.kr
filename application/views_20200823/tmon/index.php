	...
	<header>
		<nav class="navbar navbar-global navbar-fixed-top" role="navigation">
			<div class="container">
				<div class="logo ns">
					<a href="/tmon">
						<img src="/assets/images/tm_logo.png" />
		...
		<div class="container">
			...
			<div class="video">
				<div class="video-container">
					<iframe width="100%" height="100%" src="https://www.youtube.com/embed/QQIYPrpmKgw?ps=blogger&amp;controls=1&amp;iv_load_policy=3&autoplay=1" frameborder="0" allowfullscreen="true"></iframe>
				</div>
			</div>
		</div>
	</section>
	...
	<section id="product" class="mb30">
		<div class="container">
			...
			<div class="col-md-4 col-xs-6 main_list">
				<div class="product_area" onclick="location.href='/tmon/get/<?=$row->product_idx?>'">
