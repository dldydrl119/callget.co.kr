...
<body>
		...
		<nav class="navbar navbar-get navbar-fixed-top" role="navigation">
			<div class="container">
				...
				<div class="navbar-header">
                    <button type="button" class="return" onclick="location.href='/nsmall';">
				...
				<div class="get-nav">
                    <ul>
                        ...
                        <li>
                            <a href="/nsmall/call/<?=$data->product_idx?>">2 상품시청</a>
                        </li>
                        <li>
	...
	<!-- Carousel -->
        <div id="myCarousel" class="carousel slide">            
            ...
            <div class="get_area">
                <button class="get_btn" onclick="location.href='/nsmall/call/<?=$data->product_idx?>'" data-idx = "<?=$data->product_idx?>">GET 하러가기</button>
            </div>
        </div>
        <!-- carousel end -->
