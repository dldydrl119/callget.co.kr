			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="custom-collapse">
					<ul class="nav navbar-nav navbar-right">
						...
						<li>
							<a href="/ad05/about">콜겟TV란?</a>
						</li>
						<li>
							<a href="/ad05/faq">이용방법</a>
						</li>
						<!-- <li>
							<a href="/ad05/news/1">소식</a>
						</li>
						<li>
							<a href="/ad05/contactus">문의하기</a>
						</li> -->
					</ul>
				</div>
			</div><!-- Container_END -->
		...
		<div class="container">
			...
			<div class="video">
				<div class="video-container">
					<iframe width="100%" height="100%" src="https://www.youtube.com/embed/ftDFEDGtBWM?ps=blogger&amp;controls=1&amp;iv_load_policy=3&autoplay=1" frameborder="0" allowfullscreen="true"></iframe>
				</div>
			</div>
		</div>
	</section>
	...
	<section id="product" class="mb30">
		<div class="container">
			<!--<div class="main-header mb10">
			 ...
			 <div class="category">
				<ul>
                    <li class="ad05_cate_list active" data-number="0">
					...
					<li class="ad05_cate_list" data-number="<?=$cate->category_idx?>">
						<a href="javascript:void(0);">
			...
			<div class="col-md-4 col-xs-6 main_list">
				<div class="product_area" onclick="location.href='/ad05/get/<?=$row->product_idx?>'">
...
<!-- 		</div> -->
	...
	<script src="/assets/js/ad05_callgetdev.js"></script>
