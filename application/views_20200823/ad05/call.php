...
<body class="bg-lightgray">
    ...
    <section id="get_main">
        ...
        <div class="get_area">
            <button id="getcall" class="get_btn" onclick="javascript:_AceTM.PV('/event/call_<?=$data->product_idx?>.html'); location.href='tel:<?=$data->insure_call?>'" data-idx = "<?=$data->product_idx?>">CALL 상담예약하기</button>
        </div>
    </section>
    <!-- Get_Main_END -->
