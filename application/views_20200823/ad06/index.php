	...
	<section id="product" class="mb30">
		<div class="container">
			<!--<div class="main-header mb10">
			 ...
			 <div class="category">
				<ul>
                    <li class="ad06_cate_list active" data-number="0">
					...
					<li class="ad06_cate_list" data-number="<?=$cate->category_idx?>">
						<a href="javascript:void(0);">
			...
			<div class="col-md-4 col-xs-6 main_list">
				<div class="product_area" onclick="location.href='/ad06/get/<?=$row->product_idx?>'">
