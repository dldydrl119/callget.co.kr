...
<body>
	...
	<header>
		<nav class="navbar navbar-get navbar-fixed-top" role="navigation">
			<div class="container">
				<div class="logo get">
					<a href="/booknlife">
						<img src="/assets/images/bnl_logo_w.png" />
						<p>상담완료만 해도 리워드가 내집으로</p>
					</a>
				</div>

				<div class="navbar-header">
                    <button type="button" class="return" onclick="location.href='/booknlife';">
				...
				<div class="get-nav">
                    <ul>
                        ...
                        <li>
                            <a href="/booknlife/call/<?=$data->product_idx?>">2 상품시청</a>
                        </li>
                        <li>
	...
	<!-- Carousel -->
        <div id="myCarousel" class="carousel slide">            
            ...
            <div class="get_area">
                <button class="get_btn" onclick="location.href='/booknlife/call/<?=$data->product_idx?>'" data-idx = "<?=$data->product_idx?>">GET 하러가기</button>
            </div>
        </div>
        <!-- carousel end -->
